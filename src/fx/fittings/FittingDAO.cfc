<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.fx.fittings.Fitting">
		...
		<cfquery name="qRead" datasource="Mochi">
			select 	FittingID, StyleID, SampleCategoryID, PatternMakerID, CutNumber, DueDate, 
					...
					PatternStatusID, SampleStatusID, CreatedDate, CreatedBy, LastMaintainedDate, 
					LastMaintainedBy
			from Fittings
		...
		<cfscript>
			obj = createObject("component", "mochi.fx.fittings.Fitting").init();
			...
			obj.setSampleStatusID(qRead.SampleStatusID);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.fx.fittings.Fitting">
		<cfset var qCreate="">
		...
		<cfset var local12=arguments.bean.getSampleStatusID()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into Fittings(StyleID, SampleCategoryID, PatternMakerID, CutNumber, DueDate, LocationID, ContractorID, Fitter, FittingDate, ResultCodeID, PatternStatusID, SampleStatusID, CreatedDate, CreatedBy, LastMaintainedDate, LastMaintainedBy)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				where StyleID = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_INTEGER" null="#iif((local1 eq ""), de("yes"), de("no"))#" />
				  ...
				  and SampleStatusID = <cfqueryparam value="#local12#" cfsqltype="CF_SQL_INTEGER" null="#iif((local12 eq ""), de("yes"), de("no"))#" />
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			set StyleID = <cfqueryparam value="#arguments.bean.getStyleID()#" cfsqltype="CF_SQL_INTEGER" null="#iif((arguments.bean.getStyleID() eq ""), de("yes"), de("no"))#" />,
				...
				SampleStatusID = <cfqueryparam value="#arguments.bean.getSampleStatusID()#" cfsqltype="CF_SQL_INTEGER" null="#iif((arguments.bean.getSampleStatusID() eq ""), de("yes"), de("no"))#" />,
