...
<cfif IsDefined("form.reportFormat")>
	...
	<cfinvoke component="mochi.cfc.reports.Report" method="OpenProductionSamplesReportQuery" returnvariable="myQuery">
            ...
            <tr>
                ...
                <td>
                    <select name="reportFormat">
                        <option value="ProductionPatternReportWithCommentsV3.cfr">Pattern Status Chart W/ Comments
                    </select>
                </td>
            </tr>
            <tr>
