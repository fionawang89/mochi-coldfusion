<cfcomponent output="false" alias="mochi.cfc.fittingComments.FittingComment">
	<!---
	...
	--->
	<cfproperty name="FittingCommentID" type="numeric" default="0">
	...
	<cffunction name="init" output="false" returntype="FittingComment">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.FittingCommentID=stValues.fittingcommentid>
	...
	<cffunction name="getFittingCommentID" output="false" access="public" returntype="any">
		<cfreturn variables.FittingCommentID>
	</cffunction>

	<cffunction name="setFittingCommentID" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfif (IsNumeric(arguments.val)) OR (arguments.val EQ "")>
			<cfset variables.FittingCommentID = arguments.val>
		<cfelse>
