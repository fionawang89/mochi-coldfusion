<cfcomponent output="false" alias="mochi.cfc.materialTypes.MaterialType">
	<!---
	...
	<cfproperty name="MaterialType" type="string" default="">
	...
	<cffunction name="init" output="false" returntype="MaterialType">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.MaterialTypeID=stValues.MaterialTypeID>
				<cfset variables.MaterialType=stValues.MaterialType>
	...
	<cffunction name="getMaterialType" output="false" access="public" returntype="any">
		<cfreturn variables.MaterialType>
	</cffunction>

	<cffunction name="setMaterialType" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfset variables.MaterialType = arguments.val>
	</cffunction>
