<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.materialTypes.MaterialType">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	MaterialTypeID, MaterialType, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from MaterialTypes
			where MaterialTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.materialTypes.MaterialType").init();
			obj.setMaterialTypeID(qRead.MaterialTypeID);
			obj.setMaterialType(qRead.MaterialType);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.materialTypes.MaterialType">
		<cfset var qCreate="">

		<cfset var qGetId="">

		<cfset var local1=arguments.bean.getMaterialType()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into MaterialTypes(MaterialType, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				from MaterialTypes
				where MaterialType = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				...
				order by MaterialTypeID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setMaterialTypeID(qGetID.MaterialTypeID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			set MaterialType = <cfqueryparam value="#arguments.bean.getMaterialType()#" cfsqltype="CF_SQL_VARCHAR" />,
			...
			where MaterialTypeID = <cfqueryparam value="#arguments.bean.getMaterialTypeID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from MaterialTypes
			where MaterialTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getMaterialTypeID()#" />
		</cfquery>
