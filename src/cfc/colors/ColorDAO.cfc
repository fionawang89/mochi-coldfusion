<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.colors.Color">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	ColorID, ColorCode, ColorName, Description, CreatedBy, CreatedDate, 
		...
		<cfscript>
			obj = createObject("component", "mochi.cfc.colors.Color").init();
			obj.setColorID(qRead.ColorID);
			obj.setColorCode(qRead.ColorCode);
			obj.setColorName(qRead.ColorName);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.colors.Color">
		<cfset var qCreate="">

		<cfset var qGetId="">

		<cfset var local1=arguments.bean.getColorCode()>
		<cfset var local2=arguments.bean.getColorName()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into Colors(ColorCode, ColorName, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				where ColorCode = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				  and ColorName = <cfqueryparam value="#local2#" cfsqltype="CF_SQL_VARCHAR" />
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			set ColorCode = <cfqueryparam value="#arguments.bean.getColorCode()#" cfsqltype="CF_SQL_VARCHAR" />,
				ColorName = <cfqueryparam value="#arguments.bean.getColorName()#" cfsqltype="CF_SQL_VARCHAR" />,
