<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.productionStatus.ProductionStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	ProductionStatusID, Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from ProductionStatus
			where ProductionStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.productionStatus.ProductionStatus").init();
			obj.setProductionStatusID(qRead.ProductionStatusID);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.productionStatus.ProductionStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into ProductionStatus(Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by ProductionStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setProductionStatusID(qGetID.ProductionStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where ProductionStatusID = <cfqueryparam value="#arguments.bean.getProductionStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from ProductionStatus
			where ProductionStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getProductionStatusID()#" />
		</cfquery>
