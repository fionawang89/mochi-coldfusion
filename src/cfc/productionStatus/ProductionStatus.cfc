<cfcomponent output="false" alias="mochi.cfc.productionStatus.ProductionStatus">
	<!---
	...
	--->
	<cfproperty name="ProductionStatusID" type="numeric" default="0">
	...
	<cfscript>
		...
		variables.ProductionStatusID = 0;
		variables.Status = "";
	...
	<cffunction name="init" output="false" returntype="ProductionStatus">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.ProductionStatusID=stValues.ProductionStatusID>
	...
	<cffunction name="getProductionStatusID" output="false" access="public" returntype="any">
		<cfreturn variables.ProductionStatusID>
	</cffunction>

	<cffunction name="setProductionStatusID" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfif (IsNumeric(arguments.val)) OR (arguments.val EQ "")>
			<cfset variables.ProductionStatusID = arguments.val>
		<cfelse>
