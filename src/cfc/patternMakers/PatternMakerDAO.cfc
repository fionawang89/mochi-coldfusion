<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.patternMakers.PatternMaker">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	PatternMakerID, FirstName, LastName, LocationID, CreatedBy, CreatedDate, 
					LastMaintainedBy, LastMaintainedDate
			from PatternMakers
			where PatternMakerID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.patternMakers.PatternMaker").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.patternMakers.PatternMaker">
		<cfset var qCreate="">
		...
		<cfset var local3=arguments.bean.getLocationID()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into PatternMakers(FirstName, LastName, LocationID, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				where FirstName = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				  ...
				  and LocationID = <cfqueryparam value="#local3#" cfsqltype="CF_SQL_INTEGER" null="#iif((local3 eq ""), de("yes"), de("no"))#" />
				...
				order by PatternMakerID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setPatternMakerID(qGetID.PatternMakerID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where PatternMakerID = <cfqueryparam value="#arguments.bean.getPatternMakerID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from PatternMakers
			where PatternMakerID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getPatternMakerID()#" />
		</cfquery>
