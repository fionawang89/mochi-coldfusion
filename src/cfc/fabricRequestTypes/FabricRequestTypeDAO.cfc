<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.fabricRequestTypes.FabricRequestType">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	FabricRequestTypeID, Type, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from FabricRequestTypes
			where FabricRequestTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.fabricRequestTypes.FabricRequestType").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.fabricRequestTypes.FabricRequestType">
		<cfset var qCreate="">

		<cfset var qGetId="">

		<cfset var local1=arguments.bean.getType()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into FabricRequestTypes(Type, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				from FabricRequestTypes
				where Type = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				...
				order by FabricRequestTypeID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setFabricRequestTypeID(qGetID.FabricRequestTypeID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			update FabricRequestTypes
			set Type = <cfqueryparam value="#arguments.bean.getType()#" cfsqltype="CF_SQL_VARCHAR" />,
			...
			where FabricRequestTypeID = <cfqueryparam value="#arguments.bean.getFabricRequestTypeID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from FabricRequestTypes
			where FabricRequestTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getFabricRequestTypeID()#" />
		</cfquery>
