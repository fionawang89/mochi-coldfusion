<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.requestStatus.RequestStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	RequestStatusID, Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from RequestStatus
			where RequestStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.requestStatus.RequestStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.requestStatus.RequestStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into RequestStatus(Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by RequestStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setRequestStatusID(qGetID.RequestStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where RequestStatusID = <cfqueryparam value="#arguments.bean.getRequestStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from RequestStatus
			where RequestStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getRequestStatusID()#" />
		</cfquery>
