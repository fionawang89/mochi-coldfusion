<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.counterSampleStatus.CounterSampleStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	CounterSampleStatusID, Status, Description, Type, CreatedBy, CreatedDate, 
					LastMaintainedBy, LastMaintainedDate
			from CounterSampleStatus
			where CounterSampleStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.counterSampleStatus.CounterSampleStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.counterSampleStatus.CounterSampleStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into CounterSampleStatus(Status, Description, Type, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by CounterSampleStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setCounterSampleStatusID(qGetID.CounterSampleStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where CounterSampleStatusID = <cfqueryparam value="#arguments.bean.getCounterSampleStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from CounterSampleStatus
			where CounterSampleStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getCounterSampleStatusID()#" />
		</cfquery>
