<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.fabricRequestStatus.FabricRequestStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	FabricRequestStatusID, Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from FabricRequestStatus
			where FabricRequestStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.fabricRequestStatus.FabricRequestStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.fabricRequestStatus.FabricRequestStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into FabricRequestStatus(Status, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by FabricRequestStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setFabricRequestStatusID(qGetID.FabricRequestStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where FabricRequestStatusID = <cfqueryparam value="#arguments.bean.getFabricRequestStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from FabricRequestStatus
			where FabricRequestStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getFabricRequestStatusID()#" />
		</cfquery>
