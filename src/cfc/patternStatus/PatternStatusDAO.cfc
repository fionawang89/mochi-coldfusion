<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.patternStatus.PatternStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	PatternStatusID, Status, Description, Type, CreatedBy, CreatedDate, 
					LastMaintainedBy, LastMaintainedDate
			from PatternStatus
			where PatternStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.patternStatus.PatternStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.patternStatus.PatternStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into PatternStatus(Status, Description, Type, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by PatternStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setPatternStatusID(qGetID.PatternStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where PatternStatusID = <cfqueryparam value="#arguments.bean.getPatternStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from PatternStatus
			where PatternStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getPatternStatusID()#" />
		</cfquery>
