<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.materialClass.MaterialClass">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	MaterialClassID, MaterialClass, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from MaterialClass
			where MaterialClassID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.materialClass.MaterialClass").init();
			obj.setMaterialClassID(qRead.MaterialClassID);
			obj.setMaterialClass(qRead.MaterialClass);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.materialClass.MaterialClass">
		<cfset var qCreate="">

		<cfset var qGetId="">

		<cfset var local1=arguments.bean.getMaterialClass()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into MaterialClass(MaterialClass, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				select MaterialClassID
				from MaterialClass
				where MaterialClass = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				...
				order by MaterialClassID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setMaterialClassID(qGetID.MaterialClassID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			set MaterialClass = <cfqueryparam value="#arguments.bean.getMaterialClass()#" cfsqltype="CF_SQL_VARCHAR" />,
			...
			where MaterialClassID = <cfqueryparam value="#arguments.bean.getMaterialClassID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from MaterialClass
			where MaterialClassID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getMaterialClassID()#" />
		</cfquery>
