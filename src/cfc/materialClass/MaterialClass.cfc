<cfcomponent output="false" alias="mochi.cfc.materialClass.MaterialClass">
	<!---
	...
	<cfproperty name="MaterialClass" type="string" default="">
	...
	<cffunction name="init" output="false" returntype="MaterialClass">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.MaterialClassID=stValues.MaterialClassID>
				<cfset variables.MaterialClass=stValues.MaterialClass>
	...
	<cffunction name="getMaterialClass" output="false" access="public" returntype="any">
		<cfreturn variables.MaterialClass>
	</cffunction>

	<cffunction name="setMaterialClass" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfset variables.MaterialClass = arguments.val>
	</cffunction>
