<cfcomponent output="false" alias="mochi.cfc.processes.Process">
	<!---
	...
	<cfproperty name="Process" type="string" default="">
	...
	<cffunction name="init" output="false" returntype="Process">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.ProcessID=stValues.ProcessID>
				<cfset variables.Process=stValues.Process>
	...
	<cffunction name="getProcess" output="false" access="public" returntype="any">
		<cfreturn variables.Process>
	</cffunction>

	<cffunction name="setProcess" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfset variables.Process = arguments.val>
	</cffunction>
