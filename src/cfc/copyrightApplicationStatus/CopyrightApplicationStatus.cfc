<cfcomponent output="false" alias="mochi.cfc.copyrightApplicationStatus.CopyrightApplicationStatus">
	<!---
	...
	<cffunction name="init" output="false" returntype="CopyrightApplicationStatus">
