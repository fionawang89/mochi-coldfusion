<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.copyrightApplicationStatus.CopyrightApplicationStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	CopyrightApplicationStatusID, Status, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate
					
			from CopyrightApplicationStatus
			where CopyrightApplicationStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.copyrightApplicationStatus.CopyrightApplicationStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.copyrightApplicationStatus.CopyrightApplicationStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into CopyrightApplicationStatus(Status, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by CopyrightApplicationStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setCopyrightApplicationStatusID(qGetID.CopyrightApplicationStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			update CopyrightApplicationStatus
			...
			where CopyrightApplicationStatusID = <cfqueryparam value="#arguments.bean.getCopyrightApplicationStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from CopyrightApplicationStatus
			where CopyrightApplicationStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getCopyrightApplicationStatusID()#" />
		</cfquery>
