<cfcomponent output="false" alias="mochi.cfc.fittings.Fitting">
	<!---
	...
	<cffunction name="init" output="false" returntype="Fitting">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				...
				<cfset variables.Fitter=stValues.Fitter>
				<cfset variables.FittingDate=stValues.FittingDate>
				<cfset variables.ResultCodeID=stValues.ResultCodeID>
