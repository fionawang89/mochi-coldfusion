<cfcomponent output="false" alias="mochi.cfc.resultCodes.ResultCode">
	<!---
	...
	<cffunction name="init" output="false" returntype="ResultCode">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.ResultCodeID=stValues.resultcodeid>
				<cfset variables.Code=stValues.code>
	...
	<cffunction name="getCode" output="false" access="public" returntype="any">
		<cfreturn variables.Code>
	</cffunction>

	<cffunction name="setCode" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfset variables.Code = arguments.val>
	</cffunction>
