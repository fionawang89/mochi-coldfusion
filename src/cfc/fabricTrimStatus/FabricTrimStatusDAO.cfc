<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.fabricTrimStatus.FabricTrimStatus">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	FabricTrimStatusID, Status, Description, Type, CreatedBy, CreatedDate, 
					LastMaintainedBy, LastMaintainedDate
			from FabricTrimStatus
			where FabricTrimStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.fabricTrimStatus.FabricTrimStatus").init();
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.fabricTrimStatus.FabricTrimStatus">
		<cfset var qCreate="">
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into FabricTrimStatus(Status, Description, Type, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				...
				order by FabricTrimStatusID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setFabricTrimStatusID(qGetID.FabricTrimStatusID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			...
			where FabricTrimStatusID = <cfqueryparam value="#arguments.bean.getFabricTrimStatusID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from FabricTrimStatus
			where FabricTrimStatusID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getFabricTrimStatusID()#" />
		</cfquery>
