<cfcomponent output="false" alias="mochi.cfc.fabricSampleOrderStatus.FabricSampleOrderStatus">
	<!---
	...
	<cffunction name="init" output="false" returntype="FabricSampleOrderStatus">
