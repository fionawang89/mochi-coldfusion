<cfcomponent output="false" alias="mochi.cfc.entityTypes.EntityType">
	<!---
	...
	<cfproperty name="EntityType" type="string" default="">
	...
	<cffunction name="init" output="false" returntype="EntityType">
		<cfargument name="stValues" required="false" type="struct">
			<cfif IsDefined("arguments.stValues")>
				<cfset variables.EntityTypeID=stValues.EntityTypeID>
				<cfset variables.EntityType=stValues.EntityType>
	...
	<cffunction name="getEntityType" output="false" access="public" returntype="any">
		<cfreturn variables.EntityType>
	</cffunction>

	<cffunction name="setEntityType" output="false" access="public" returntype="void">
		<cfargument name="val" required="true">
		<cfset variables.EntityType = arguments.val>
	</cffunction>
