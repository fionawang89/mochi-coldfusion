<cfcomponent output="false">
	...
	<cffunction name="read" output="false" access="public" returntype="mochi.cfc.entityTypes.EntityType">
		<cfargument name="id" required="true">
		<cfset var qRead="">
		<cfset var obj="">

		<cfquery name="qRead" datasource="Mochi">
			select 	EntityTypeID, EntityType, Description, CreatedBy, CreatedDate, LastMaintainedBy, 
					LastMaintainedDate
			from EntityTypes
			where EntityTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.id#" />
		</cfquery>

		<cfscript>
			obj = createObject("component", "mochi.cfc.entityTypes.EntityType").init();
			obj.setEntityTypeID(qRead.EntityTypeID);
			obj.setEntityType(qRead.EntityType);
	...
	<cffunction name="create" output="false" access="public">
		<cfargument name="bean" required="true" type="mochi.cfc.entityTypes.EntityType">
		<cfset var qCreate="">

		<cfset var qGetId="">

		<cfset var local1=arguments.bean.getEntityType()>
		...
		<cftransaction isolation="read_committed">
			<cfquery name="qCreate" datasource="Mochi">
				insert into EntityTypes(EntityType, Description, CreatedBy, CreatedDate, LastMaintainedBy, LastMaintainedDate)
				values (
			...
			<cfquery name="qGetID" datasource="Mochi">
				select EntityTypeID
				from EntityTypes
				where EntityType = <cfqueryparam value="#local1#" cfsqltype="CF_SQL_VARCHAR" />
				...
				order by EntityTypeID desc
			</cfquery>
		</cftransaction>

		<cfscript>
			arguments.bean.setEntityTypeID(qGetID.EntityTypeID);
		</cfscript>
	...
	<cffunction name="update" output="false" access="public">
		...
		<cfquery name="qUpdate" datasource="Mochi" result="status">
			update EntityTypes
			set EntityType = <cfqueryparam value="#arguments.bean.getEntityType()#" cfsqltype="CF_SQL_VARCHAR" />,
			...
			where EntityTypeID = <cfqueryparam value="#arguments.bean.getEntityTypeID()#" cfsqltype="CF_SQL_INTEGER">
		</cfquery>
		<cfreturn arguments.bean />
	</cffunction>
	...
	<cffunction name="delete" output="false" access="public" returntype="void">
		...
		<cfquery name="qDelete" datasource="Mochi" result="status">
			delete
			from EntityTypes
			where EntityTypeID = <cfqueryparam cfsqltype="CF_SQL_INTEGER" value="#arguments.bean.getEntityTypeID()#" />
		</cfquery>
